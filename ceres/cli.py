    ...
    rules = sorted(
        {
            ...
            "ceres.model.artifact.pickle_parse_error",
            ...
            "ceres.model.gguf.architecture_drift",
            "ceres.model.gguf.metadata_drift",
            "ceres.model.gguf.tensor_count_drift",
            "ceres.model.onnx.header_invalid",
            "ceres.model.onnx.metadata_oversized",
            "ceres.model.onnx.metadata_drift",
            "ceres.model.onnx.opset_drift",
            "ceres.model.onnx.operator_drift",
